<?php
if (session_status() === PHP_SESSION_NONE) { require __DIR__ . '/config/bootstrap.php';
 }
...
<div class="header">
  ...
  <a href="/galerija_sarajevo/register_en.php" title="English">🇬🇧</a>
</div>
  ...
  <div class="card" style="max-width:520px;margin:2rem auto;">
    ...
    <form method="post">
      ...
      <div style="margin-top:.8rem; display:flex; gap:.5rem;">
        <button class="btn primary">Kreiraj nalog</button>
        <a class="btn" href="/galerija_sarajevo/login.php">Nazad</a>
      </div>

      <div style="text-align:center; margin-top:1rem;">
        <span class="note">Već imate nalog?</span>
        <a href="/galerija_sarajevo/login.php" style="color:#0a65c0; text-decoration:none; font-weight:600;">Prijavite se ovdje</a>
      </div>
    </form>
  </div>
</div>

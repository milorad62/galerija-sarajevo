...
<?php $TITLE="Umjetnici — DigitalnaGalerija"; require __DIR__ . '/../db.php';
...
<?php foreach ($artists as $a): ?>
  <div class="card">
    <h3>
      <a href="/pages/artist.php?id=<?= $a['id'] ?>">
        <?= htmlspecialchars($a['ime'].' '.$a['prezime']) ?>
      </a>
    </h3>
    <p class="muted"><?= htmlspecialchars($a['email'] ?: '') ?></p>
    <a class="badge" href="/pages/artist.php?id=<?= $a['id'] ?>">Pogledaj djela</a>
  </div>
<?php endforeach; ?>
</div>
